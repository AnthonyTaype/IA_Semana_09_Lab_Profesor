...
public class Libreria extends JFrame implements ActionListener {
	...
	void obtenerPrecio(){
		if(marca == "Stanford"){ pre = 4.85;}
		else if(marca == "Alpha"){ pre = 4.36;}
	...
	void calcularLapiceros(){
		if(marca=="Standford"){lapicero=5;}
		else if(marca=="Alpha"){lapicero=4;}
		else if(marca=="Justus"){lapicero=3*cant;}
		else{lapicero=2*cant;}
	}
